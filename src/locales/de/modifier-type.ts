...
export const modifierType: ModifierTypeTranslationEntries = {
  ModifierType: {
    ...
    "TOXIC_ORB": { name: "Toxik-Orb", description: "Ein Item zum Tragen. Dieser bizarre Orb vergiftet seinen Träger im Kampf schwer." },
    "FLAME_ORB": { name: "Heiß-Orb", description: "Ein Item zum Tragen. Dieser bizarre Orb fügt seinem Träger im Kampf Verbrennungen zu." },
