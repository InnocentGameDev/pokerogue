...
- ### High priority
    ...
    - 🐛 MEs calculate what's happening before Biome loads, which means potential bugs on floor changes (11, 21...)
...
- ## Bugless implementation of the MVP MEs
  ...
  - 🟣 Bug-ish implementation of Epic ME 1 ('Training Session') 🛠️
